                ...
                <div class="row">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="/mapel/{{ $mapel->id }}/update" method="POST" id="mapel_form"
                                enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="kode">Kode</label>
                                    <input type="text" class="form-control" name="kode" id="kode"
                                        aria-describedby="kode" placeholder="Kode" value="{{ $mapel->kode }}">
                                </div>
                                <span class="text-danger">{{ $errors->first('kode') }}</span>
                                <div class="form-group">
                                    <label for="nama_mapel">Nama</label>
                                    <input type="text" class="form-control" name="nama_mapel" id="nama_mapel"
                                        aria-describedby="nama_mapel" placeholder="Nama Mata Pelajaran"
                                        value="{{ $mapel->nama }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="semester" id="semester">
                                        <option value="ganjil" @if ($mapel->semester == 'ganjil') selected @endif>Ganjil
                                        </option>
                                        <option value="genap" @if ($mapel->semester == 'genap') selected @endif>Genap
                                        </option>
                                    </select>
                                </div>

                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="right">
                                <button type="button" class="btn" data-toggle="modal" data-target="#tambahData">Tambah
                                    Data
                                    Siswa</button>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($data_siswa as $siswa)
                                        <tr>
                                            <th><a href="siswa/{{ $siswa->id }}/profile">{{ $siswa->nama_depan }}</a>
                                            </th>
                                            <th><a href="siswa/{{ $siswa->id }}/profile">{{ $siswa->nama_belakang }}</a>
                                            </th>
                                            <th>{{ $siswa->email }}</th>
                                            <th>{{ $siswa->no_telp }}</th>
                                    ...
                                    <form id="siswa_form" method="POST" action="javascript:void(0)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_belakang"
                                                id="nama_belakang" aria-describedby="nama_belakang"
                                                placeholder="Nama Belakang">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="text" class="form-control" name="email" id="email"
                                                ariadescribedby="email" placeholder="Email">
